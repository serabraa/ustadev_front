...
const resources = {
  ...
  am: {
    translation: {
      ...
      services: {
        ...
        items: {
          ...
          mobile: {
            ...
            description: 'Բնիկ և խաչաձև հարթակային բջջային հավելվածներ iOS-ի և Android-ի համար'
          },
              backend: {
                title: 'ԱԻ և API ինտեգրում',
                description: 'Ինտեգրում ենք ԱԻ հնարավորություններ և երրորդ կողմի API-ներ ձեր արտադրանքում'
              },
          cloud: {
            title: 'Ամպային ծառայություններ',
            description: 'Ամպային ենթակառուցվածքի կարգավորում, միգրացիա և օպտիմիզացիա'
          },
              design: {
                title: 'Խաղերի զարգացում',
                description: 'Պլանավորում և ստեղծում ենք թեթև վեբ և բջջային խաղեր'
              },
              consulting: {
                title: 'Սերվերի հոսթինգ',
                description: 'Անվտանգ սերվերի տեղակայում, շահագործում և ենթակառուցվածքի սպասարկում'
              }
        }
      },
      projects: {
        title: 'Նախագծեր',
        subtitle: 'Մեր վերջին աշխատանքների և հաջող իրականացումների ցուցադրություն',
        viewProject: 'Դիտել նախագիծը',
        viewAll: 'Բոլոր նախագծերը',
        items: {
          ecommerce: {
            title: 'Կայք գեղեցկության սրահի համար',
          ...
          mobile: {
            title: 'QR ստեղծում և սերվերի հոսթինգ',
            description: 'QR կոդերի ստեղծում և նվիրված սերվերի տեղակայում հաճախորդի համար',
            tech: 'Python, FastAPI, Docker, Nginx, QR գործիքներ, CI/CD'
          },
          dashboard: {
            title: 'CryptoBro – AI կրիպտո թրեքեր',
            description: 'iOS հավելված՝ AI վերլուծությամբ, գների ահազանգերով և ֆոնում ծանուցումներով',
            tech: 'Swift, SwiftUI, BackgroundTasks, OpenAI API, CoinGecko API, CryptoPanic API, CoreML'
          },
          portfolio: {
            title: 'Russian Blackjack (Unity խաղ)',
            description: 'Քարտային խաղ՝ ներշնչված բլեքջեքից՝ ռուսական ռուլետկա մեխանիկայով',
            tech: 'Unity, C#, ShaderLab, Cinemachine, Addressables'
          },
          saas: {
            title: 'Telegram ամրագրման բոտ',
            description: 'Telegram բոտ՝ ժամադրությունների ամրագրման և ծանուցումների համար',
            tech: 'Python, Telegram Bot API, SQLite, OpenAI API, LangChain, Redis'
          },
          api: {
            title: 'LOTR Converter (iOS)',
            description: 'Ֆանտաստիկ թեմայով արժույթների փոխարկիչ՝ հարթ UI-ով և օֆլայն աշխատանքի աջակցությամբ',
            tech: 'Swift, UIKit, Haptics, CoreAnimation, CoreData'
          }
        }
      },
      about: {
        title: 'Մեր մասին',
        subtitle: 'Կառուցում ենք տեխնոլոգիաների ապագան՝ մեկ նախագիծ միանգամից',
        description: 'Մենք եռանդուն թիմ ենք՝ մշակողներ, դիզայներներ և նորարարներ, որոնք նվիրված են բացառիկ թվային փորձառությունների ստեղծմանը: Տարիների փորձով առաջադեմ տեխնոլոգիաներում՝ մենք օգնում ենք բիզնեսներին վերափոխել իրենց գաղափարները հզոր թվային լուծումների:',
        teamTitle: 'Մեր թիմը',
        ...
        stats: {
          projects: '50+',
          projectsLabel: 'Ավարտված նախագծեր',
          clients: '30+',
        ...
        values: {
          quality: {
            ...
            desc: 'Մենք երբեք չենք զիջում որակի հարցում՝ ապահովելով, որ յուրաքանչյուր նախագիծ համապատասխանի ամենաբարձր չափանիշներին:'
          },
          innovation: {
            title: 'Նորարարություն',
            desc: 'Մենք ընդունում ենք նոր տեխնոլոգիաներ և ստեղծագործական լուծումներ բարդ խնդիրների լուծման համար:'
          },
          collaboration: {
            title: 'Համագործակցություն',
            desc: 'Մենք սերտորեն աշխատում ենք մեր հաճախորդների հետ՝ որպես գործընկերներ նրանց թվային փոխակերպման ճանապարհին:'
          }
        }
      }
      ,
